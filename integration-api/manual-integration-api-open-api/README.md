...
{% openapi src="../../.gitbook/assets/swagger spelling checked.yaml" path="/payment/{merchantID}" method="post" %}
...
| hash            | This is the data to ensure that data integrity has passed from senangPay to the merchant’s shopping cart. Refer to [this section](generate-secure-hash.md#how-to-verify-if-the-secure-hash-is-correct) for more info.                                                     |
