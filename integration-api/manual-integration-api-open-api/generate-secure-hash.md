...
The string to be hashed is _$str = **53-784Shopping\_cart\_id\_3024.5056**_ which will generate the hash value of :
...
4\. Now you need to compare the hash value that you have generated with the hash value sent from senangPay. If the values do not match, the data may have been tampered with. Please contact [help@senangpay.my](mailto:help@senangpay.my) for further assistance.
